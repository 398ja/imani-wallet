...
// Android back button, status bar. No-op in a browser.
initNative()
...
// One frame after React has committed, so the splash lifts onto real content
// rather than onto an empty root. No-op in a browser.
