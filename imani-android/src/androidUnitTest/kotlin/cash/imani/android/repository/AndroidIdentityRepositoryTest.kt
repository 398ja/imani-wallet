...
class AndroidIdentityRepositoryTest {
     ...
     */
    @Test
    fun `createIdentity stores identity with encrypted private key`() = runTest {
        // Given
     ...
     */
    @Test
    fun `listIdentities returns all identities ordered by lastUsedAt`() = runTest {
        // Given
     ...
     */
    @Test
    fun `getIdentity retrieves correct identity by ID`() = runTest {
        // Given
     ...
     */
    @Test
    fun `getIdentity returns failure when identity not found`() = runTest {
        // When
     ...
     */
    @Test
    fun `deleteIdentity removes identity from database and Keystore`() = runTest {
        // Given
        val created = createTestIdentity("Test Identity")
        repository.saveIdentity(created)
     ...
     */
    @Test
    fun `updateLabel updates identity label successfully`() = runTest {
        // Given
     ...
     */
    @Test
    fun `updateLabel validates label length`() = runTest {
        // Given
     ...
     */
    @Test
    fun `markAsUsed updates lastUsedAt timestamp`() = runTest {
        // Given
        val created = createTestIdentity("Test Identity")
        repository.saveIdentity(created)
