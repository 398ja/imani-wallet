...
class AndroidVoucherRepositoryTest {
     ...
     */
    @Test
    fun `saveVoucher stores voucher in database`() =
        runTest {
            // Given
     ...
     */
    @Test
    fun `listVouchers returns all vouchers ordered by issuedAt`() =
        runTest {
            // Given
     ...
     */
    @Test
    fun `getVoucher retrieves correct voucher by ID`() =
        runTest {
            // Given
            val voucher = createTestVoucher("voucher-1")
     ...
     */
    @Test
    fun `getVoucher returns failure when voucher not found`() =
        runTest {
            // When
     ...
     */
    @Test
    fun `updateVoucherStatus updates voucher status successfully`() =
        runTest {
            // Given
     ...
     */
    @Test
    fun `deleteVoucher removes voucher and associated proofs from database`() =
        runTest {
            // Given
            val voucher = createTestVoucher("voucher-1")
            repository.saveVoucher(voucher)
     ...
     */
    @Test
    fun `getVouchersByStatus filters vouchers by status`() =
        runTest {
            // Given
     ...
     */
    @Test
    fun `saveProofs stores proofs in database`() =
        runTest {
            // Given
            val proofs =
                listOf(
     ...
     */
    @Test
    fun `getProofsByVoucher retrieves proofs associated with voucher`() =
        runTest {
            // Given
            val voucher = createTestVoucher("voucher-1")
            repository.saveVoucher(voucher)
     ...
     */
    @Test
    fun `selectProofsForAmount selects proofs using FIFO strategy`() =
        runTest {
            // Given
            val proofs =
                listOf(
     ...
     */
    @Test
    fun `selectProofsForAmount throws when insufficient balance`() =
        runTest {
            // Given
            val proofs =
                listOf(
     ...
     */
    @Test
    fun `markProofAsSpent updates spentAt timestamp`() =
        runTest {
            // Given
     ...
     */
    @Test
    fun `getUnspentBalance calculates total unspent balance correctly`() =
        runTest {
            // Given
            val proofs =
                listOf(
     ...
     */
    @Test
    fun `observeVouchers returns Flow of all vouchers`() =
        runTest {
            // Given
            repository.saveVoucher(createTestVoucher("voucher-1"))
            repository.saveVoucher(createTestVoucher("voucher-2"))
     ...
     */
    @Test
    fun `observeVouchersByStatus returns Flow filtered by status`() =
        runTest {
            // Given
            repository.saveVoucher(createTestVoucher("voucher-1", VoucherStatus.ISSUED))
            repository.saveVoucher(createTestVoucher("voucher-2", VoucherStatus.REDEEMED))
