...
| 2.7 | Integration Testing (Nostr) | M (3d) | ✅ DONE | de1aa72 | NostrVoucherRepositoryTest (11 tests); VoucherFlowTest (7 tests); JVM-only integration tests; Complete voucher lifecycle tests; Multi-device sync tests; Cache behavior tests; Offline mode tests; NIP-33 event replacement tests | 2.3, 2.4, 2.6 |
